...
public class NavigableSetTest extends SortedSetTest {
    ...
    protected NavigableSet<Integer> set(List<Integer> elements, Comparator<Integer> comparator) {
        return (NavigableSet<Integer>) super.set(elements, comparator);
    }


    protected NavigableSet<Integer> treeSet(List<Integer> elements, Comparator<Integer> comparator) {
